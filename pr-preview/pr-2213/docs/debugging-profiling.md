...
- Full command reference: [Commands](/agent-device/pr-preview/pr-2213/docs/commands.md)
- Node.js observability APIs: [Node.js API](/agent-device/pr-preview/pr-2213/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-2213/docs/sessions.md)
