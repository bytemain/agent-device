...
import type { InteractionRouteExecutionInput, RefSnapshotFlagGuardResponse } from './types.ts';
...
export type TargetedTouchParams = InteractionRouteExecutionInput & {
...
function readTargetedTouchStalenessWarning(
  session: SessionState,
  req: InteractionRouteExecutionInput['req'],
