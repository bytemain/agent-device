...
import { createInteractionRuntime, finalizeTouchInteraction } from './interaction-route-support.ts';
...
import type { InteractionRouteExecutionInput } from './types.ts';

type GestureHandlerParams = InteractionRouteExecutionInput;
...
type GestureInteractionOutcome = {
  positionals: string[];
  flags: InteractionRouteExecutionInput['req']['flags'];
...
async function runPreparedGesture(
  ...
  internal: InteractionRouteExecutionInput['req']['internal'],
...
function gestureReplayFlags(
  input: GesturePayload,
  flags: InteractionRouteExecutionInput['req']['flags'],
): InteractionRouteExecutionInput['req']['flags'] {
