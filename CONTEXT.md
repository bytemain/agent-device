...
traversal depth kept apart from presented depth, and narrowing only where a backend proves it
complete.
...
ancestor projection, scroll hints, collapsed depth); platform differences are fold policy.
